    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
          <div>
            <p className="mb-3 font-semibold md:mb-4 text-medical-primary">Excellence</p>
            <h1 className="heading-h2 mb-5 font-bold md:mb-6 text-medical-dark">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
              ...
              <Link href="/contact-us">
                <button className="inline-flex items-center justify-center gap-3 rounded-button whitespace-nowrap transition-all duration-200 ease-in-out focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 gap-2 text-medical-primary p-0 hover:text-medical-dark">
                  Contact
                  <svg
          ...
          <div>
            <img
              ...
              alt="CAHMGT Excellence in Healthcare - Award-winning home health care services and accreditation"
            />
          </div>
        </div>
      </div>
